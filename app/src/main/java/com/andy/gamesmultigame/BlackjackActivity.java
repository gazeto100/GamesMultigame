...
public class BlackjackActivity extends Activity implements View.OnClickListener {
    ...
    Vector<Integer> vCards = new Vector<Integer>();
    Vector<Integer> vPoint = new Vector<Integer>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtDilarPoint.setTextColor(Color.BLACK);
        txtDilarPoint.setTextSize(15);
        txtDilarPoint.setVisibility(View.INVISIBLE);


        txtPlayerPoint = (TextView)findViewById(R.id.txtPlayerPoint);
        txtPlayerPoint.setTextColor(Color.BLACK);
        txtPlayerPoint.setTextSize(15);
    ...
    public void HitLog(){
        ...
        playerCards.add(vCards.get(randomIndex));
        playerPoints.add(vPoint.get(randomIndex));
        iPlayerPoint += vPoint.get(randomIndex);

        PlayrCardsView[size].setImageResource(playerCards.get(size));
        txtPlayerPoint.setText(String.valueOf(iPlayerPoint));

        vCards.remove(randomIndex);
        vPoint.remove(randomIndex);
    ...
    public void clearAllUp21(){
        if (iPlayerPoint > 21){
            ...
            dilarCards.add(vCards.get(randomIndex));
